...
// LeaseDuration is the default duration used to initially create a lease and to extend it thereafter.
...
// SetLeaseDuration sets the lease duration used for dequeue and lease extension.
